...
--]]
prefix = "http://paravance-15:8080/tools.descartes.teastore.webui/" -- "http://10.1.1.1:8080/tools.descartes.teastore.webui/"
productviewcount = 30
postIndex = {1} --[ {3, 11}
...
--[[	"", --]]
--[[	"login", --]]
	"loginAction?username=user"..userpostfix.."&password=password",
...
--[[	elseif callnum == 4 then
	...
	elseif isPost(callnum) then
		print("POST - "..calls[callnum])
		return "[POST]"..prefix..calls[callnum]
	else
		print("NOPOST - "..calls[callnum])
